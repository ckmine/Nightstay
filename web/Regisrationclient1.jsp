<%-- 
    Document   : Regisrationclient1
    Created on : Mar 30, 2018, 8:19:09 PM
    Author     : CKmine
--%>
...
<div class="container">
			...
			<header>
				<h1><span>Night Stay</span> REGISTER-HERE</h1>
            </header>       
      <div  class="form">
    		<form id="contactform"> 
            ...
            <input id="phone" name="phone" placeholder="mobile number" required="" type="text"> <br>
             <input type="checkbox" name="t&c" value="t&c"> <select class="select-styl" name="tc">
